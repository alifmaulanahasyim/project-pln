<x-guest-layout>
    ...
    <form method="POST" action="{{ route('register') }}" class="space-y-5">
        ...
        <div>
            ...
            />
            <p class="text-xs text-gray-500 mt-1">Only Gmail addresses are allowed (e.g., user@gmail.com)</p>
        ...
        <div>
            ...
            <x-text-input id="password_confirmation" class="block mt-1 w-full"
                          ...
                          maxlength="8"
            />
            <p class="text-xs text-gray-500 mt-1">Make sure it matches the password above.</p>
