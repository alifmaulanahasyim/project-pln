...
<head>
    ...
    <title>Formulir Mahasiswa Magang</title>
...
<body class="gradient-bg" x-data="{ isOpen: false, expanded: false, currentStep: 1, showSuccess: false }">
    <main class="max-w-5xl mx-auto px-4 py-8 relative z-10">
        <div class="glass-card rounded-3xl overflow-hidden">
            ...
            @php
                // Cek variabel alreadyInserted dari controller
                $alreadyInserted = isset($alreadyInserted) ? $alreadyInserted : false;
            @endphp

            @if ($alreadyInserted)
                <div class="p-8 text-center text-lg text-green-700 font-semibold">
                    Anda sudah pernah mengisi formulir. Satu akun hanya bisa mengisi satu kali.
                </div>
            @else
